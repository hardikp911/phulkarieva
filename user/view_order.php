            ...
            <div class="container pb-5 mt-n2 mt-md-n3">
                <div class="row">
                    <div class="col-xl-12 col-md-12 border">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST' || (isset($_GET['id']) && isset($_GET['user_id']) && isset($_GET['invoice_id']))) {
                                            ...
                                            <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                                                ...
                                                <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem">
                                                    ...
                                                    <?php } ?> <?php if ($filter === "Returned") {
                                                                ...
                                                                ?>
                                                        <h4> <span class="badge bg-primary rounded-pill"><?php echo $delivered; ?></span></h4>
                                                    <?php } ?>
                                                    </p>
